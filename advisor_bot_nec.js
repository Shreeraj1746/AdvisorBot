...
// enable witai middleware
controller.middleware.receive.use(wit.receive);

// use middleware to process message and infer intent
controller.hears(['ORGANIZATION'], 'direct_message', wit.hears, function(bot, message) {
  bot.reply(message,"One or more 'ORGANIZATION' type of named enteties detected.");
});

controller.hears(['LOCATION'], 'direct_message', wit.hears, function(bot, message) {
  bot.reply(message,"One or more 'LOCATION' type of named enteties detected.");
});

controller.hears(['PERSON'], 'direct_message', wit.hears, function(bot, message) {
  bot.reply(message,"One or more 'PERSON' type of named enteties detected.");
});

controller.hears(['MISC'], 'direct_message', wit.hears, function(bot, message) {
  bot.reply(message,"One or more 'MISC' type of named enteties detected.");
});
